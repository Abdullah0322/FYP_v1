  ...
  getUser() async {
    try {
      ...
      setState(() {
        ...
        Sell.userData.phone = snap1['shopname'].toString();
        Sell.userData.phone = snap1['about us'].toString();
      });
    } catch (e) {
      print(e);
    }
      ...
      onTap: () {
        return showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                title: Text(
                  'Are you sure you want to Update Shop Description?',
