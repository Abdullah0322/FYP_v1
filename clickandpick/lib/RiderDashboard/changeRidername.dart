...
class Ridername extends StatefulWidget {
  @override
  _RidernameState createState() => _RidernameState();
}

class _RidernameState extends State<Ridername> {
  ...
  getUser() async {
    try {
      ...
      setState(() {
        ...
        Rider.userData.phone = snap1['phone'].toString();
      });
    } catch (e) {
      print(e);
    }
