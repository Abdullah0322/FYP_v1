  ...
  getUser() async {
    try {
      DocumentSnapshot snap1 = await FirebaseFirestore.instance
          ...
          .get();
      setState(() {
        Manager.userData.username = snap1['collection point'].toString();
        Manager.userData.email = snap1['email'].toString();
        //Manager.userData.details = snap1['details'].toString();
        ;
      });
    } catch (e) {
      print(e);
      ...
      onTap: () {
        return showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                title: Text(
                  'Are you sure you want to Update Collection Point Information?',
