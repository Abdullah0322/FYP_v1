...
class Fragances extends StatefulWidget {
  @override
  _FragancesState createState() => _FragancesState();
}

class _FragancesState extends State<Fragances> {
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          try {
                                                                            ...
                                                                            FirebaseFirestore.instance.collection('seller').doc(user.email).collection('products').doc('category').collection('fragrances').doc(ds['id'].toString()).update({
                                                                              'name': nameECon.text,
